...
export function parseBibleReference(input: string): { book: string; chapter: number; verse?: number } | null {
  ...
  const found = BIBLE_BOOKS.find((b) => b.name.toLowerCase() === rawBook.toLowerCase());
